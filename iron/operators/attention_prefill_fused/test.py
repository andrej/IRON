...
# bf16 pipeline with 17 fused ops and 3 chained GEMMs accumulates significant
# rounding error. These tolerances are validated for H=2 (K=128) and H=32
# (K=2048).
REL_TOL = 0.99
ABS_TOL = 128.0
MAX_ERROR_RATE = 0.05
...
def test_attention_prefill_fused(H, G, d, E, S):
    ...
    errors = verify_buffer(
        output, "attn_output", golden["attn_output"].reshape(S, E),
