...
- **rope.cpp**: The C++ host code to run RoPE on the NPU.
- **rope_golden.py**: A Python script containing the golden reference implementation for validation.
- **rope.py**: The Python code describing the data movement through the NPU to run RoPE.
