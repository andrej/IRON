...
def main():
    parser = argparse.ArgumentParser(
        description="Generate PyTorch golden reference for AX+Y function."
    )
    parser.add_argument(
        "--dtype",
        type=str,
    ...
    parser.add_argument("--scalar_factor", type=float, default=42, help="Scalar factor")
    ...
    s = torch.tensor(args.scalar_factor, dtype=dtype)
